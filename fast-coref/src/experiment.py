...
class Experiment:
    ...
    def __init__(self, config: DictConfig):
        ...
        if not self.eval_model:
            ...
            if self._is_training_remaining():
                ...
                logging.info('No training remaining!')
    ...
    def train(self) -> None:
        ...
        while True:
            ...
            for dataset, dataset_train_data in self.data_iter_map["train"].items():
                ...
                if self.num_train_docs_map.get(dataset, None) is not None and self.num_train_docs_map.get(dataset) != 'None':
    ...
    def load_model(self, location: str, last_checkpoint=True) -> None:
        ...
        self.model.load_state_dict(checkpoint["model"], strict=False)
        # TODO: make this optional self.train_info = checkpoint["train_info"]
